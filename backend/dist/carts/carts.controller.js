...
let CartsController = class CartsController {
    ...
    async updateCartItem(itemId, updateDto) {
...
], CartsController.prototype, "getUserCart", null);
__decorate([
    (0, common_1.Post)('user/:userId/add'),
    __param(0, (0, common_1.Param)('userId')),
...
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], CartsController.prototype, "getCartTotal", null);
